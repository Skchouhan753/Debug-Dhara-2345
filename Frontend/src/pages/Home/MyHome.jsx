...
const MyHome = () => {
  ...
  //<a href="https://ibb.co/x57ypJf"><img src="https://i.ibb.co/JksNf5y/fitbit-earnings.png" alt="fitbit-earnings" border="0"></a>
  //<a href="https://ibb.co/g39zrWy"><img src="https://i.ibb.co/Y3QpNd2/fitbitcycle.png" alt="fitbitcycle" border="0"></a>
  ...
  return (
    ...
    <MainDiv>
      <AdvDiv>
        <img src="https://img.freepik.com/free-vector/cartoon-gym-with-equipment-rainy-cityscape-view-window-vector-illustration-fitness-center-with-treadmill-ellipse-cycling-machine-dumbbell-fitball-punshing-bag-workout-sport-activity_107791-23192.jpg?w=996&t=st=1712082340~exp=1712082940~hmac=280da82c7098e4766e30c96202cd04584457124e8d33b76d7351df8a7ed40804" alt="" />
      </AdvDiv>
      <BodyDiv>
        <LeftDiv>
          <SummaryDiv>
        ...
        <RightDiv>
          <RightAdv>
            <img src="https://i.ibb.co/RyQR1ft/Premium-Man.png" alt="" />
          </RightAdv>
          <Para1>
            <div>
      ...
      <Adv2>
        <img
          src="https://i.ibb.co/JksNf5y/fitbit-earnings.png"
          alt=""
        />
      </Adv2>
    </MainDiv>
